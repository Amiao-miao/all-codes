...
class TopicView(View):
    ...
    def get(self,request,author_id):
        ...
        # 增加文章详情页功能时  ?tid=2
        #所以有无tid这个查询字符串,接收详情页和列表页的区别


        # 1 分类的思考
        # v1/topics/Amiao  #所有的分类
        # v1/topics/Amiao?category=tec|no-tec #技术或非技术文章列表
        ...
        if t_id:
            ...
            # 非博主访问自己,增加条件,limit='public'
                ...
                try:
                    ...
                    result = {'code': 10311, 'error': 'topic id is error'}
                    return JsonResponse(result)
        ...
        for msg in all_messages:
            if msg.parent_message:
                ...
                msg_list.append({
                    ...
                    'content':msg.content,
                    'publisher':msg.user_profile.nickname,
                    'publish_avatar':str(msg.user_profile.avatar),
                    'created_time':msg.created_time.strftime('%Y-%m-%d %H:%M:%S'),
                    'reply':[]
                })
        # 将回复与评论关联
