...
INSERT INTO `cls` VALUES (1,'Lily',18,'w',84),(2,'Tom',17,'m',86),(3,'Abby',16,'w',98),(4,'James',16,'o',93),(5,'Lay',18,'w',89);
/*!40000 ALTER TABLE `cls` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cls1_bak`
--

DROP TABLE IF EXISTS `cls1_bak`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cls1_bak` (
  `name` varchar(30) NOT NULL,
  `age` tinyint(3) unsigned DEFAULT NULL,
  `score` float DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `cls1_bak`
--

LOCK TABLES `cls1_bak` WRITE;
/*!40000 ALTER TABLE `cls1_bak` DISABLE KEYS */;
INSERT INTO `cls1_bak` VALUES ('Lily',18,84),('Tom',17,86),('Abby',16,98),('James',16,93),('Lay',18,89);
/*!40000 ALTER TABLE `cls1_bak` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `cls_bak` VALUES (1,'Lily',18,84,'sing,dance',48800.9);
...
--
-- Table structure for table `frined`
--
...
--
-- Dumping data for table `frined`
--

LOCK TABLES `frined` WRITE;
/*!40000 ALTER TABLE `frined` DISABLE KEYS */;
/*!40000 ALTER TABLE `frined` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `hobby` VALUES (1,'Lily','sing,dance',48800.9,NULL,'练舞奇才'),(2,'Bob','draw',8800,NULL,'当代达芬奇'),(3,'Jame','sing',24600,NULL,'天籁之音'),(4,'Emma','dance',4600,NULL,NULL),(5,'Anna','sing',24600,NULL,NULL),(6,'','draw',188000,NULL,NULL),(7,'Likky','draw',188000,NULL,NULL),(8,'Kittt','draw',188000,NULL,NULL);
...
INSERT INTO `marathon` VALUES (1,'赵四','1995-10-01','2020-10-30 10:08:23','02:42:58'),(2,'王五','1996-08-30','2020-09-28 13:59:59','04:02:03'),(3,'孙柳','1999-05-20','2020-10-28 06:49:01','03:29:30'),(4,'李诶诶','1999-08-08','2020-12-03 11:07:11',NULL);
...
INSERT INTO `person` VALUES (1,'Lily',29,'w',20000.00,'2017-04-03',2),(2,'Tom',27,'m',16000.00,'2019-10-03',1),(3,'Joy',30,'m',28000.00,'2016-04-03',1),(4,'Emma',24,'w',8000.00,'2019-05-08',4),(5,'Abby',28,'w',17000.00,'2018-11-03',3),(6,'Jame',32,'m',22000.00,'2017-04-07',3);
...
/*!50001 VIEW `good_stu` AS select `cls`.`id` AS `id`,`cls`.`name` AS `name`,`cls`.`age` AS `age`,`cls`.`sex` AS `sex`,`cls`.`score` AS `score` from `cls` where (`cls`.`score` > 85) */;
...
-- Dump completed on 2020-12-08 11:23:20
